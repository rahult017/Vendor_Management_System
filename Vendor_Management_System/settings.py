...
SECRET_KEY = 'django-insecure-vk=2v8nsy#*au-vai%jadnyf#08o=gs$h4^4xwqk$)a1d^2v-i'
...
LOGGING = {
    ...
    "filters": {
        "ignore_unwanted_logs": {"()": "Vendor_Management_System.log_filters.IgnoreUnwantedLogs"},
    },
    "formatters": {
        "console": {
